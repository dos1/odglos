...
static struct SceneDefinition SCENES[] = {
	...
	{"lira_korbowa", .freezes = {{0, "DSCF8976_maska"}}, .repeats = 1}, {"male_dziwne_cos", .freezes = {{0, "DSCF8646_maska"}}, .repeats = 1}, {"turkusowe_cos", .freezes = {{0, "DSCF9030_maska"}}, .repeats = 1},
	//{">dzwonki"},
	{"animacja_silacz1", .freezes = {{0, "silacz_maska"}, {22, "silacz_maska"}, {46, "silacz_maska"}}},
	{"donice_02_samochod_duzy_jedzie_w_lewo"},
	{"donice_03_samochod_duzy_wjezdza_do_donicy_z_lewej", .freezes = {{6, "donice_w_ogrodzie_maski"}}},
	...
	{"donice_14_samochod_nadjezdza_z_prawej_i_wjezdza_do_donicy_z_lewej"},
