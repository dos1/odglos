...
static struct SceneDefinition SCENES[] = {
	...
	{"silacz2_maly_samochod_z_sowka_opuszcz_cien_rozny"},
	...
	{"male_dziwne_cos"},
	{"ul_duzy_TAK"},
	{"duza_sowka_na_drewnianym_kole"},
	{">pergola"},
	{"pergola_animacja_koncowa2"},
	{"pergola_animacja_koncowa6"},
	{"sowka_wchodzi_do_miski_ciemniejsze"},
...
bool Dispatch(struct Game* game) {
	do {
		game->data->sceneid++;
		if (game->data->sceneid == sizeof(SCENES) / sizeof(struct SceneDefinition)) {
			return false;
		}
