...
static struct SceneDefinition SCENES[] = {
	...
	{"sowka_idzie_w_lesie"},
	{"kuzyn_w_lesie"},
	{"sowka_konfrontacja_z_rzezba", .freezes = {{0, "masks/DSCF8160_maska.png"}}},
	{"wrzosy_kuzyn_i_sowka2"},
	{"samochod_kominek"},
	{"samochody_w_lesie", .freezes = {{0, "masks/DSCF2433_maska.png"}}},
	{"buty_drewniane"},
	...
	{"wchodzenie_po_schodach_samochod_sowka", .freezes = {{19, "masks/maska_schodek1.png"}, {23, "masks/maska_schodek2.png"}, {26, "masks/maska_schodek3.png"}, {29, "masks/maska_schodek4.png"}}},
	...
	{"swiecznik3_TAK", .freezes = {{0, "masks/DSCF2296_maska_caly.png"}}},
	//{">swiecznik"},
	{"gawron_i_drewniany_medrzec", .freezes = {{107, "masks/DSCF2982_maska.png"}}},
	...
	{"animacja_silacz1", .freezes = {{0, "masks/silacz_maska.png"}, {22, "masks/silacz_maska.png"}, {46, "masks/silacz_maska.png"}}},
	...
	{"silacz2_maly_samochod_z_sowka_opuszcz_cien_rozny", .freezes = {{0, "masks/silacz_maska.png"}}},
	...
	{"silacz3_maly_samochod_sam", .freezes = {{0, "masks/silacz_maska.png"}}},
	{"lira_korbowa", .freezes = {{0, "masks/DSCF8976_maska.png"}}},
	{"siatka_na_drzewie_myszka"},
	{"rzezby_w_lazience_2_wyciszenie_sznureczka"},
	{"sowka_i_rzezby_2_krotsze", .freezes = {{18, "masks/DSCF7440_maska.png"}}},
	{"031_donice_dom1"},
	{"turkusowe_cos", .freezes = {{0, "masks/DSCF9030_maska.png"}}},
	{"ule_jesienne"},
	...
	{"male_dziwne_cos", .freezes = {{0, "masks/DSCF8646_maska.png"}}},
	{"ul_duzy_TAK", .freezes = {{0, "masks/IMG_0053_maska.png"}}},
	{"duza_sowka_na_drewnianym_kole", .freezes = {{13, "masks/IMG_1010_maska.png"}}},
	{">pergola"},
	{"pergola_animacja_koncowa2"},
	{"pergola_animacja_koncowa6"},
	{"sowka_wchodzi_do_miski_ciemniejsze", .freezes = {{0, "masks/DSCF1595_maska.png"}}},
	...
	{"donica_w_hortensjach_06_waz"},
	{">pudelka"},
	{"waz_zmienia_sie_w_kostke", .freezes = {{14, "masks/IMG_0770_maska.png"}}},
	{">lawka"},
	{"drzewko_kolorowe1_maskotki_podwojne_moze_lepsze_TAK"},
	{"czerwona_sciana_z_winorosli"},
	{"pudelko_wypluwa_szczypczyki_smok_bez_dyn_TAK", .freezes = {{0, "masks/DSCF5025_maska.png"}}},
	{">naparstki"},
	{"01statki_szyszki_tasmy_animacja1"},
	{"02statki_szyszki_tasmy_animacja2"},
	{"03statki_szyszki_tasmy_animacja3"},
	{"04statki_szyszki_tasmy_gra_dzwiek1", .freezes = {{0, "masks/DSCF4234_maska.png"}}},
	{"04statki_szyszki_tasmy_gra_dzwiek2", .freezes = {{0, "masks/DSCF4234_maska.png"}}},
	{"04statki_szyszki_tasmy_gra_dzwiek3", .freezes = {{0, "masks/DSCF4234_maska.png"}}},
	{"05statki_szyszki_tasmy_animacja4", .freezes = {{69, "masks/DSCF4999_maska.png"}}},
	{"06statki_szyszki_tasmy_animacja5"},
	{">armata"},
	{"podniebny_generator_z_kosmosem", .freezes = {{0, "masks/podniebny_generator_z_kosmosem00_maska.png"}}},
	...
	{"duch_portalu_animacja2_zlozona_TAK", .callback = DuchPortalu, .freezes = {{0, "masks/duch_portalu_oczy_osobno00_maska.png"}}},
	...
	{"sowki_zamieniaja_sie_krzeslami_po_dwa_i_nie_znikaja_TAK", .freezes = {{85, "masks/DSCF0566_maska_obszary.png"}}},
	{"sowka1_wlacza_konsole_z_daleka2", .bg = "kosmos.png"},
	{"sowka1_wlacza_konsole_z_bliska1", .freezes = {{0, "masks/DSCF0067_maska_ze_stolem.png"}}},
	{"sowka1_zaluzje"},
	{"sowka1_wchodzi_na_stol_z_bliska_nie_znika_TAK"},
	{"drzwi_zamykaja_sie_same", .bg = "kosmos.png"},
	{"sowka2_klika_konsole_nie_znika_TAK", .freezes = {{0, "masks/DSCF0286_maska.png"}}},
	{"sowka2_zaluzje_nie_znika_TAK"},
	{"okna_sie_otwieraja_z_sowka2", .bg = "kosmos.png"},
	{"pudelko_w_ogrodzie", .freezes = {{22, "masks/pudelko_w_ogrodzie_maska1.png"}, {56, "masks/pudelko_w_ogrodzie_maska3.png"}, {93, "masks/pudelko_w_ogrodzie_maska2.png"}, {119, "masks/pudelko_w_ogrodzie_maska3.png"}, {157, "masks/pudelko_w_ogrodzie_maska2.png"}, {183, "masks/pudelko_w_ogrodzie_maska3.png"}}},
	{"buzia"},
