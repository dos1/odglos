...
int Gamestate_ProgressCount = 17;
...
void* Gamestate_Load(struct Game* game, void (*progress)(struct Game*)) {
	...
	data->character = CreateCharacter(game, "sowka_idzie_w_pd_wsch_przyciete");
...
static CHARACTER_CALLBACK(GoForward) {
	SwitchCurrentGamestate(game, "sowka_idzie_w_prawo_przyciete");
}
