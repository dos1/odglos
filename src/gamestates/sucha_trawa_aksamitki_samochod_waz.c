...
int Gamestate_ProgressCount = 47;
...
void* Gamestate_Load(struct Game* game, void (*progress)(struct Game*)) {
	...
	data->character = CreateCharacter(game, "sucha_trawa_aksamitki_samochod_waz");
...
static CHARACTER_CALLBACK(GoForward) {
	SwitchCurrentGamestate(game, "zielona_trawa_samochod_waz");
}
